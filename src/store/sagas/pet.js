...
export function* registerPetRequest({ data }) {
  try {
    ...
    Toast.show(`O(a) ${response.data.name} foi cadastrado com sucesso!`, Toast.SHORT, Toast.TOP, {
      ...general.toast,
...
export function* getPetRequest() {
  try {
    ...
    yield put(PetActions.failure());
    Toast.show('Houve um erro ao recuperar seus pets! \nTente novamente...', Toast.SHORT, Toast.TOP, {
      ...general.toast,
      ...general.toastDanger,
    });
  }
